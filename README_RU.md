...
- ⚡ Умная проверка зависимостей: системные пакеты (python3, curl и др.) устанавливаются только при отсутствии
- 🚀 Быстрая переустановка: пропускает apt-get update если все зависимости установлены
- 🐛 Исправление: исправлена опечатка в проверке директории установки
